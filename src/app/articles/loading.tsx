...
const ArticleLoading = () => {
  return (
    <section className="fix-height container m-auto px-5 animate-pulse">
        <div className="my-5 w-full md:w-2/3 m-auto bg-gray-300 h-10 rounded "></div>
        ...
        <div 
        className="  w-full block t p-1 bg-gray-400 rounded-lg h-8"></div>
      </div>
        ))}
        </div>
        <div className='flex  items-center justify-center mt-2 mb-10'>
            <div className="bg-gray-300 w-48 rounded-sm h-9">
