...
const ArticlesPage = async({searchParams} : ArticlePageProps) => {
  ...
  const pages = Math.ceil(count / articlesPerPage)
  ...
  return (
    <section className="container m-auto px-5 ">
     ...
     <PaginationArticles pageNumber= {parseInt(pageNumber)} route="/articles" pages={pages}/>
    </section>
...
// u can add title for article page in page not just layout
